  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1200px] mx-auto px-5 sm:px-6 pt-10 sm:pt-14 pb-12 sm:pb-16">
        ...
        {/* Stats strip — mobile: coluna, desktop: linha */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-6 mb-8 sm:mb-12 pb-6 sm:pb-8 border-b border-[var(--border)] opacity-0-init anim-fade-up">
          <div className="flex flex-wrap gap-x-6 gap-y-2">
            {[
              ...
              <div key={label} className="flex items-baseline gap-1.5">
                <span className="font-extrabold text-lg sm:text-xl" style={{ color: "var(--blue)" }}>{value}</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-10 lg:gap-16 items-start">
          ...
          {/* LEFT */}
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider mb-4 opacity-0-init anim-fade-up"
              style={{ color: "var(--blue)", fontFamily: "var(--font-mono)" }}>
              Gráfica Digital & Papelaria · Caucaia, CE
            </p>

            <h1 className="font-extrabold leading-[1.08] tracking-tight mb-5 opacity-0-init anim-slide-left"
            ...
            <p className="leading-relaxed mb-7 opacity-0-init anim-fade-up anim-delay-1"
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-8 opacity-0-init anim-fade-up anim-delay-2">
            ...
            <div className="flex flex-wrap gap-4 opacity-0-init anim-fade-up anim-delay-3">
              {["Desde 2004", "Entrega expressa", "Instalação inclusa"].map((item) => (
          ...
          <div className="opacity-0-init anim-fade-up anim-delay-1">
            <div className="rounded-2xl border bg-white p-6 sm:p-7"
